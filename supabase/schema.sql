...
insert into public.products (slug, name, description, category, price_base, dimensions, materials, featured) values
  ...
  ('cable-organizer-set', 'Desk Cable Organizer Set', 'Set of 6 snap-in cable clips plus a under-desk raceway. Keeps your setup clean.',              'functional', 12.00, '90 × 25 × 20 mm',   '[{"type":"PLA","surcharge":0},{"type":"PETG","surcharge":3}]', false),
